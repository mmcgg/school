...
%     theta = theta + w*dt;
    ...
    [mu,sigma,K] = EKF_localization(mu, sigma, u, z, m, dt, alpha,sigma_range, sigma_bearing);
    
    state_est_hist = [state_est_hist; mu'];
    sigma_hist = [sigma_hist; sigma(1,1) sigma(2,2) sigma(3,3)];
    K_hist = [K_hist; sigma(1,1) sigma(1,2) sigma(2,1) sigma(2,2) sigma(3,1) sigma(3,2)];
